...
export const InvoiceModal: React.FC<InvoiceModalProps> = ({
  ...
  useEffect(() => {
    if (initialData) {
      ...
      setStatus('pending');
      setPaidAmount(0);
      setNotes('Payment to be made via bank transfer to the account details shown above. We kindly request payment within the due date specified. For any queries, please contact our accounts team. No VAT is applicable. Above 60 days of non-payment will result in halting the current works.');
