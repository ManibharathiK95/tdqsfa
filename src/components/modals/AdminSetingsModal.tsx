  ...
  return (
    <div className="fixed inset-0 z-50 bg-slate-950/80 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-slate-900 border border-slate-800 rounded-2xl w-full max-w-2xl shadow-2xl p-6 relative my-8">
        ...
        {/* Tab 1: Manage Users & PINs */}
        {activeTab === 'users' && (
          <div className="space-y-6 text-xs">
            {/* User List with Editable PINs */}
            <div>
                ...
                {userList.map((u) => (
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      <div
                        className={`w-8 h-8 rounded-lg ${u.avatarColor} text-white flex items-center justify-center font-bold text-xs`}
                      >
            ...
            <form onSubmit={handleAddUser} className="bg-slate-950 border border-slate-800 p-4 rounded-xl space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-slate-900 border border-slate-800 font-mono font-bold text-center text-white rounded-xl px-3 py-1.5"
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                className="w-full py-2 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-xl shadow transition-all"
              >
        ...
        {/* Tab 2: Company Profile & Currency */}
        {activeTab === 'company' && (
